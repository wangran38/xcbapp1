...
const usePage = {
  ...
  methods: {
    async loadPageData() {
      if (!this.hasMore || this.pageLoading)
        return;
    ...
    // 检测还有没有下一页
    querySuccess(data) {
      if (data == null ? void 0 : data.listdata) {
    ...
    handleFetchError(error) {
      common_vendor.index.__f__("error", "at hooks/usePage.js:63", "Error loading data:", error);
    },
    // 初始化
    resetPagination() {
      this.page = 1;
...
//# sourceMappingURL=../../.sourcemap/mp-weixin/hooks/usePage.js.map
